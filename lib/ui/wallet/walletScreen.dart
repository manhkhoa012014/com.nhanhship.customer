                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: (payStackSettingData != null && payStackSettingData!.isEnabled),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(vertical: 3.0, horizontal: 20),
                            child: Card(
                              shape: RoundedRectangleBorder(
                        ...
                        Visibility(
                          visible: (razorPayData != null && razorPayData!.isEnabled),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(vertical: 3.0, horizontal: 20),
                            child: Card(
                              shape: RoundedRectangleBorder(
                        ...
                        Visibility(
                          visible:(paytmSettingData != null && paytmSettingData!.isEnabled),
                          child: Padding(
                            padding: const EdgeInsets.symmetric(vertical: 3.0, horizontal: 20),
                            child: Card(
                              shape: RoundedRectangleBorder(
