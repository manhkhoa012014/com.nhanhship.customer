                ...
                child: ElevatedButton.icon(
                    label: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: Colors.grey.shade200),
                        ).tr()),
                    icon: Padding(
                ...
                child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Color(COLOR_PRIMARY), fontWeight: FontWeight.bold, fontSize: 17),
                      ),
                    ])),
              ),
            )
