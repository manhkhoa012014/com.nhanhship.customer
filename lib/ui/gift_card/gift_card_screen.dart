...
class _GiftCardScreenState extends State<GiftCardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Tùy chọn Thẻ quà tặng", style: TextStyle(color: Color(COLOR_PRIMARY), fontSize: 18, fontWeight: FontWeight.bold)),
        centerTitle: false,
        actions: [
          InkWell(
              onTap: () {
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                Expanded(
                                    child: Text("Số tiền Thẻ quà tặng",
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: 18),
                            child: Text("Thêm lời nhắn (Tùy chọn)".toUpperCase(),
                                style: TextStyle(fontSize: 16, color: isDarkMode(context) ? Colors.grey.shade700 : Colors.grey.shade700, fontWeight: FontWeight.w600)),
                          ),
                          Expanded(child: Divider()),
                        ],
